import {
  datatable_default
} from "./chunk-XUDN2JYV.js";
import {
  file_upload_default
} from "./chunk-ENJE4TUY.js";
import {
  afterTransition,
  classToClassList,
  debounce,
...
var HSCarousel = class _HSCarousel extends HSBasePlugin {
  ...
  buildSingleDot(ind) {
    ...
    if (this.dotsItemClasses)
      classToClassList(this.dotsItemClasses, singleDot);
...
var HSComboBox = class _HSComboBox extends HSBasePlugin {
  ...
  isItemExists(obj) {
    return this.items.some((el) => {
      ...
      let group = null;
      if (groupField && ((_a = params == null ? void 0 : params.group) == null ? void 0 : _a.name))
  ...
  buildToggle() {
    ...
    if (this.isOpened) {
      if ((_a = this == null ? void 0 : this.toggle) == null ? void 0 : _a.ariaExpanded)
        this.toggle.ariaExpanded = "true";
      if ((_b = this == null ? void 0 : this.input) == null ? void 0 : _b.ariaExpanded)
        this.input.ariaExpanded = "true";
    } else {
      if ((_c = this == null ? void 0 : this.toggle) == null ? void 0 : _c.ariaExpanded)
        this.toggle.ariaExpanded = "false";
      if ((_d = this == null ? void 0 : this.input) == null ? void 0 : _d.ariaExpanded)
  ...
  open(val) {
    ...
    setTimeout(() => {
      var _a, _b;
      if ((_a = this == null ? void 0 : this.input) == null ? void 0 : _a.ariaExpanded)
        this.input.ariaExpanded = "true";
      if ((_b = this == null ? void 0 : this.toggle) == null ? void 0 : _b.ariaExpanded)
        this.toggle.ariaExpanded = "true";
      this.el.classList.add("active");
      this.animationInProcess = false;
    });
  ...
  close(forceClose = false) {
    ...
    return new Promise((resolve) => {
      ...
      if (forceClose)
        ...
        afterTransition(this.animationTarget, () => closeFn(resolve));
    });
  }
  // Static methods
  static getInstance(target, isInstance) {
...
var HSSelect = class _HSSelect extends HSBasePlugin {
  constructor(el, options) {
    ...
    this.toggleSeparators = {
      ...
      ...concatOptions == null ? void 0 : concatOptions.toggleSeparators
    };
  ...
  setToggleIcon() {
    ...
    if (icon) {
      ...
      icon.append(img);
      if (!img || !(img == null ? void 0 : img.src))
  ...
  async remoteSearch(val) {
    ...
    pseudoOptions.forEach((el) => {
      ...
      if (!newIds.includes(dataId) && !((_a = this.value) == null ? void 0 : _a.includes(el.getAttribute("data-value"))))
        ...
        newIds = newIds.filter((item) => item !== dataId);
    });
  ...
  open() {
    ...
    setTimeout(() => {
      var _a2;
      if ((_a2 = this == null ? void 0 : this.toggle) == null ? void 0 : _a2.ariaExpanded)
        this.toggle.ariaExpanded = "true";
  ...
  addOption(items) {
    ...
    const addOption = (option) => {
      ...
      if (!hasOption) {
        ...
        if (selected && !this.isMultiple)
          this.onSelectOption(val);
      }
    };
...
var HSTabs = class _HSTabs extends HSBasePlugin {
  ...
  open(el) {
    ...
    if ((_b = this == null ? void 0 : this.current) == null ? void 0 : _b.ariaSelected)
...
var _HSTreeView = class _HSTreeView extends HSBasePlugin {
  ...
  initItems() {
    this.el.querySelectorAll("[data-hs-tree-view-item]").forEach((el, ind) => {
      ...
      if (!el.id)
        el.id = `tree-view-item-${_HSTreeView.group}-${ind}`;
      const concatData = {
        ...data,
        id: data.id ?? el.id,
  ...
  update() {
    this.items.map((el) => {
      ...
      if (el.path !== this.getPath(selector))
...
if (typeof DataTable !== "undefined" && typeof jQuery !== "undefined") {
  import("./datatable-JBN7O4S2.js").then((module) => {
    HSDataTableModule = module.default;
  });
} else {
  HSDataTableModule = null;
}
if (typeof _ !== "undefined" && typeof Dropzone !== "undefined") {
  import("./file-upload-4RI3ZR2Q.js").then((module) => {
    HSFileUploadModule = module.default;
  });
} else {
  HSFileUploadModule = null;
}
if (typeof noUiSlider !== "undefined") {
  import("./range-slider-64TN3DBE.js").then((module) => {
    HSRangeSliderModule = module.default;
  });
} else {
