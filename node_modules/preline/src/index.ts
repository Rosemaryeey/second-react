...
// Dynamically import the modules if they are defined in the environment
if (typeof DataTable !== 'undefined' && typeof jQuery !== 'undefined') {
  import('./plugins/datatable').then(module => {
...
if (typeof _ !== 'undefined' && typeof Dropzone !== 'undefined') {
  import('./plugins/file-upload').then(module => {
...
if (typeof noUiSlider !== 'undefined') {
  import('./plugins/range-slider').then(module => {
